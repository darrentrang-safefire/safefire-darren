...
UR_SERVER_IP = "192.168.50.111" #"169.254.238.19" #set this to local ip address that will run ui_calibration_v2.py. do the same in polyscope
UR_SERVER_PORT = 30000
TESTING_FLAG = 1
DTMS_BORESCOPE_SPACKLE = 0
PATH_TO_SN = "M:/darren/fiber_testing/X800395_744283_M3902"
CONFIG_FILE_PATH = "M:/darren/fiber_testing/X800395_744283_M3902/setup.config"
		...
		while True:
			try:
				...
				if ok >= 0 and ok <= 9:
					...
					self.ur_connection.move_robot_arm2(int(theo_pos_x), int(theo_pos_y), wait=1)
				elif ok == 13:
